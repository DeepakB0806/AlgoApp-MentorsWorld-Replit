        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="text-center p-8">
              ...
              <h4 className="text-xl font-semibold text-foreground mb-3">Define Strategies</h4>
              <p className="text-muted-foreground">
                Configure trading rules, position sizes, and risk parameters for each strategy
              </p>
            </div>
            ...
            <div className="text-center p-8">
              ...
              <p className="text-muted-foreground">
                Trades execute automatically through Kotak Neo API when signals are received
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <div className="p-6 rounded-xl border border-border bg-card/50 hover-elevate">
              ...
              <h4 className="text-lg font-semibold text-foreground mb-2">Webhook Logging</h4>
              <p className="text-muted-foreground text-sm">
                Complete audit trail of every alert received and trade executed
              </p>
            </div>
